...
export class AppriseService {
    ...
    notitfySuccess(msg: string, valign: string = "top", halign: string = "center") {
        this._global.nativeExtra.showNotification(2, valign, halign, msg);
    }
    notitfyError(msg: string, valign: string = "top", halign: string = "center") {
        this._global.nativeExtra.showNotification(4, valign, halign, msg);
    }
    notitfyWarning(msg: string, valign: string = "top", halign: string = "center") {
        this._global.nativeExtra.showNotification(3, valign, halign, msg);
    }
    notitfyInfo(msg: string, valign: string = "top", halign: string = "center") {
